...
export const translations = {
  da: {
    ...
    paintImportClose: 'Luk',
    paintDrop: 'Vælg et billede i to tydelige farver. Billedet bliver på din egen enhed.',
    paintFormats: 'PNG, JPEG eller WebP, højst 12 MB. Hele billedet bruges som den flettede firkant.',
    paintChooseFile: 'Vælg fil',
    paintImportWorking: 'Arbejder …',
    paintImportFailed: 'Billedet kunne ikke bruges. Prøv et andet.',
    paintImportTooLarge: 'Vælg en fil på højst 12 MB.',
    paintImportUnsupported: 'Vælg et billede i PNG, JPEG eller WebP.',
    paintImportPixelsTooLarge: 'Formindsk billedet til under 24 megapixels.',
  ...
  en: {
    ...
    paintImportTitle: 'Import picture',
    paintImportClose: 'Close',
    paintDrop: 'Choose a picture in two clear colours. It stays on your own device.',
    paintFormats: 'PNG, JPEG or WebP, at most 12 MB. The whole picture is used as the woven square.',
    paintChooseFile: 'Choose file',
    paintImportWorking: 'Working …',
    paintImportFailed: 'The picture could not be used. Try another one.',
    paintImportTooLarge: 'Please choose a file smaller than 12 MB.',
    paintImportUnsupported: 'Please choose a PNG, JPEG or WebP picture.',
    paintImportPixelsTooLarge: 'Please resize the picture below 24 megapixels.',
