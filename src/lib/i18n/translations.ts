export const translations = {
  da: {
    ...
    pngImportHint: 'Bedst resultat med et beskåret billede af en sort/hvid skabelon (gerne med begge halvdele side om side).',
    pngTwoHalves: 'Billedet har 2 halvdele',
    pngSwapHalves: 'Byt halvdele',
    pngTrace: 'Spor skabelon',
    pngTracing: 'Sporer...',
    pngImportFailed: 'Kunne ikke importere PNG',
  ...
  en: {
    ...
    pngImportHint: 'Best results with a cropped black/white template image (ideally with both halves side-by-side).',
    pngTwoHalves: 'Image has 2 halves',
    pngSwapHalves: 'Swap halves',
    pngTrace: 'Trace template',
    pngTracing: 'Tracing...',
    pngImportFailed: 'Failed to import PNG',
