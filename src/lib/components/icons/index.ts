// Stroke icons for the redesign chrome, ported from the mockup generator's `I` map.
// All of them take { size = 20, class } plus any SVG attribute, and paint with
...
export { default as FitIcon } from './FitIcon.svelte';
