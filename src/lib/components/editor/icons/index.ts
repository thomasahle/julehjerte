...
// seven node/segment glyphs exist only inside the editor, so they live next to it.
// Same contract: { size = 20, class } plus any SVG attribute, stroke 2 (lucide's
// default) in `currentColor`, which lets the active tool button invert to white.
